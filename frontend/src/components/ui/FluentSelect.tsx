...
const FluentSelect: React.FC<FluentSelectProps> = ({ label, options, id, className, ...props }) => {
  ...
  // 与FluentButton保持一致的样式
  const baseStyle = "block w-full pl-4 pr-10 py-2.5 border border-gray-300 rounded-md text-gray-800 bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 ease-in-out appearance-none bg-no-repeat shadow-sm hover:bg-gray-100 hover:border-gray-400";
